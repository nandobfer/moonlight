...
function spell.onCastSpell(player, variant)
	...
	myFamiliar:setOutfit({lookType = 3})
	...
	player:setStorageValue(Storage_.FamiliarSummon, os.time() + 24*60*60*1000) -- 24 hours from now
	addEvent(removeFamiliar, 24*60*60*1000, myFamiliar:getId(), player:getId())
