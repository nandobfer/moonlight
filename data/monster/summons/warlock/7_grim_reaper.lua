local mType = Game.createMonsterType("Summoned Grim Reaper")
local monster = {}
...
monster.defenses = {
	defense = 35,
	armor = 35,
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 50, maxDamage = 105, target = false},
