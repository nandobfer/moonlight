...
local portalKeyword = keywordHandler:addKeyword({'portal'}, StdModule.say, {npcHandler = npcHandler,
		text = {
			'Posso te ensinar o feitico de teleporte pra Carlin. Tem interesse?',
	...
	portalKeyword:addChildKeyword({'yes'}, StdModule.say, {npcHandler = npcHandler,
		text = 'Eh so conjurar as palavras magicas *exani tele carlin*.',
		reset = true, ungreet = true}, nil,
		function(player) player:setStorageValue(Storage_.teleport.carlin, 1) end)
